...
Existen muchas, muchíiiiiiiisimas formas para visualizar la información. 

¿Qué deberíamos elegir? 

Esto depende de lo que queramos hacer.
...
Y la lista podría seguir creciendo...

Al analizar datos nos hacemos la pregunta: 

¿qué debería utlizar para visualizar esta información?

Acá les presento una guía algo resumida:

![](flowchartmod.jpg) 

¿Y para la visualización de *texto* que podríamos utilizar? 

Trataremos de cubrir esta pregunta más adelante, sin embargo, adentrarse en el mundo de la visualización es descubrir que existe una gama mucho más amplia, versatil e interesante a la hora de representar gráficamente nuestra data. 
...
Podríamos mostrar los gráficos *clásicos* en R para representar la información, pero los usuarios de R han creado unas librerías expectaculares con el fin de mejorar la visualización gráfica ee los datos. 
